...
@section('content')
    ...
    <form method="post" action="/games/games" enctype="multipart/form-data">
        {{ csrf_field() }}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input name="image" type="file" id="gameimageid" class="custom-file-input" required value="{{ old('releasedate') }}">
