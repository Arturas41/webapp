        ...
        <v-row justify="center">
            <v-col cols="8">
                ...
                <v-card class="mx-auto" outlined>
                    <v-list-item three-line>
                        <v-list-item-content>
                            <v-list-item-title class="headline mb-1">Note</v-list-item-title>
                            <v-list-item-subtitle>{{data.note}}</v-list-item-subtitle>
                        </v-list-item-content>
                    </v-list-item>
                </v-card>
            ...
            <v-col cols="4">
                ...
                <v-card class="mx-auto" outlined>
                    <v-list-item three-line>
                        <v-list-item-content>
                            <v-list-item-title class="headline mb-1">Actions</v-list-item-title>
                        </v-list-item-content>
                    </v-list-item>
                ...
                <v-card class="mx-auto" outlined>
                    <v-list-item three-line>
                        <v-list-item-content>
                            <v-list-item-title class="headline mb-1">Tags</v-list-item-title>
